...
tasks = [
  ...
  {name: 'Club Flyer', hours: 1, deadline: DateTime.new(2022,11,28), location: 'Online', price: 8,
    description: 'Bwog needs flyers to recruit our new members. Make us seem cool! Can use canva', user_id: 1, completed: false},
  ...
  {name: 'Pick up packages', hours: 0.5, deadline: DateTime.new(2022,12,4), location: 'Wein Hall', price: 5,
    description: 'I have been procrastinating this for two weeks please help', user_id: 1, completed: false},
  ...
  {name: 'Makeup Needed', hours: 1, deadline: DateTime.new(2022,11,15), location: 'Furman Hall', price: 15,
    description: 'Need someone to do my makeup for my sorority formal', user_id: 1, completed: false},
  ...
  {name: 'Buy me groceries', hours: 0.5, deadline: DateTime.new(2022,12,11), location: 'Westside', price: 10,
    description: 'I will reimburse you + give $10. I need 1 lb chicken breast and soy sauce. Thanks!', user_id: 1, completed: false}
]
tasks.each do |task|
  Task.create!(task)
end
