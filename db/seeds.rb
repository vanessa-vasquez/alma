...
tasks = [
  ...
  {name: 'Need brownie pan', hours: 3, deadline: DateTime.new(2022,12,6), location: 'Carman Floor 5 Kitchen', price: 3,
    description: 'I am making brownies for my friends and need a pan!', user_id: 6, completed: false},
  {name: 'Help moving out', hours: 4, deadline: DateTime.new(2022,12,3), location: 'Woodbridge Hall', price: 60,
    description: 'Need help moving out of my dorm, will buy you lunch', user_id: 6, completed: false},
  {name: 'Club Flyer', hours: 1, deadline: DateTime.new(2022,11,28), location: 'Online', price: 8,
    description: 'Bwog needs flyers to recruit our new members. Make us seem cool! Can use canva', user_id: 6, completed: false},
  ...
  {name: 'Pick up packages', hours: 0.5, deadline: DateTime.new(2022,12,4), location: 'Wein Hall', price: 5,
    description: 'I have been procrastinating this for two weeks please help', user_id: 6, completed: false},
  {name: 'LinkedIn profile pic needed', hours: 0.5, deadline: DateTime.new(2022,11,5), location: 'Law Bridge', price: 10,
    description: 'Need someone to take a professional photo of me on the Law Bridge. Bring your own camera.', user_id: 1, completed: false},
  {name: 'Makeup Needed', hours: 1, deadline: DateTime.new(2022,11,15), location: 'Furman Hall', price: 15,
    description: 'Need someone to do my makeup for my sorority formal', user_id: 6, completed: false},
  ...
  {name: 'Buy me groceries', hours: 0.5, deadline: DateTime.new(2022,12,11), location: 'Westside', price: 10,
    description: 'I will reimburse you + give $10. I need 1 lb chicken breast and soy sauce. Thanks!', user_id: 6, completed: false}
]
tasks.each do |task|
  Task.create!(task)
end
